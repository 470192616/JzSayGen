<%@ Page Title="" Language="C#" MasterPageFile="~/JM/Site1.Master" AutoEventWireup="true" CodeBehind="UIIntroList.aspx.cs" Inherits="JzSayDemo.JM.UIIntroList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Holder1" runat="server">
    ...
    <%        
        ...
        for (int inx = 0, ldc = this.ListData.Count; inx < ldc; inx++)
        {
            ...
            moveCmd.AppendFormat("<a href=\"UIIntroEdit.aspx?urlKey={0}&backUrl={1}\" title=\"编辑\"><i class=\"icon-edit\"></i></a> ", curKey, this.GoUrl);
    %>
        <tr>                        
            <td><%=curKey%></td>            
            <td><%=d.Title%></td>
